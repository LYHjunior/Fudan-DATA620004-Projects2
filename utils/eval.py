...
def eval_ap_2d(gt_boxes, gt_labels, pred_boxes, pred_labels, pred_scores, iou_thread, num_cls):
    ...
    for label in range(num_cls)[1:]:
        ...
        mIoU[label] = total_iou / total_gts
    return all_ap, acc, mIoU
...
if __name__=="__main__":
    ...
    eval_dataset = VOCDataset(root_dir='/home/lyh/lyh/data/VOC/VOC2007', resize_size=[800, 1333],
